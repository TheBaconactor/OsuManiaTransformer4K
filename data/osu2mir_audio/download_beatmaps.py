...
def main():
    ...
    parser.add_argument("--env-file", type=str,
                       default=None,
                       help="Optional path to a .env file (defaults to config/osu_api.env if present)")
    ...
    default_env_path = (repo_root / "config" / "osu_api.env")
    fallback_env_path = (script_dir / ".env")
    if args.env_file:
