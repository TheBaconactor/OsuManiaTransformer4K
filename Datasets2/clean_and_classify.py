"""
Datasets2 cleaner + status classifier.
...
Goals:
  ...
  3) Write gitignored index files under Datasets2/metadata/ for easier training/eval selection.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Clean and classify Datasets2 by osu! rank status")
    parser.add_argument("--dataset-dir", type=str, default="Datasets2", help="Datasets2 root folder")
    parser.add_argument(
        "--metadata-dir",
        type=str,
        default=None,
    ...
    default_env = (script_root.parent / "Datasets" / ".env").resolve()
